  ...
  return (
    <SubscriptionWrap>
      ...
      <p>
        ...
        projects! We offer two subscription levels - "Start" and "Pro," designed
        to cater to the diverse needs and ambitions of our users. Let's explore
      ...
      <h4>
        By subscribing to the "Pro" level, you unlock the full potential of our
        service. With the "Pro" subscription, you'll have everything that
        "Start" offers, plus:
      </h4>
      <SubscriptionList>
        <li>
        ...
        <li>
          The ability to upload images without quality loss. This means you can
          confidently share screenshot of your projects without worrying about
      ...
      <p>
        Please let us know if you need anything else or if you have any further
        questions.{' '}
        <Link href="mailto:commitmakers@gmail.com" target="blank">
          commitmakers@gmail.com
        </Link>
